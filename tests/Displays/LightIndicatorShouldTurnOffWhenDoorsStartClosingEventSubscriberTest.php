...
use Kata\Displays\LightIndicatorShouldTurnOffWhenDoorsStartClosingEventSubscriber;
use Kata\Structure\DoorEvent;
use PHPUnit\Framework\TestCase;

/**
 * @covers \Kata\Displays\LightIndicatorShouldTurnOffWhenDoorsStartClosingEventSubscriber
 */
