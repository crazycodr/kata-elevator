...
use Kata\Displays\LightIndicatorShouldTurnOnWhenDoorsStartOpeningEventSubscriber;
use Kata\Structure\DoorEvent;
use PHPUnit\Framework\TestCase;

/**
 * @covers \Kata\Displays\LightIndicatorShouldTurnOnWhenDoorsStartOpeningEventSubscriber
 */
