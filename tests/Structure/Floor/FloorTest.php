...
/**
 * @covers \Kata\Structure\Floor\Floor
 */
class FloorTest extends TestCase
{
    ...
    public function testCallingElevatorShouldIndeedChangeTheTargetFloorOnTheElevator(): void
    {
        ...
        EventPipeline::getInstance()->addSubscriber(new ElevatorSetsTargetWhenNoTargetAndFloorButtonEventOccursEventSubscriber($elevator));
